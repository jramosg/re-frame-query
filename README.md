...
```clojure
;; deps.edn
{:deps {com.shipclojure/re-frame-query {:mvn/version "0.12.0"}}}

;; Leiningen/Boot
[com.shipclojure/re-frame-query "0.12.0"]
```
...
| [Request Attempts](docs/request-attempts.md) | Protect the cache from late responses and logically cancel attempts |
